...
namespace Bilioteca.Migrations
{
    ...
    [Migration("20260508001158_TabelaListaEspera")]
    partial class TabelaListaEspera
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bilioteca.Entidades.Emprestimo", b =>
                {
                    b.HasOne("Bilioteca.Entidades.Usuario", "Funcionario")
                        .WithMany()
                        .HasForeignKey("FuncionarioId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Bilioteca.Entidades.Usuario", "Leitor")
                        .WithMany()
